...
class BleboxWlightBoxSLight(LightEntity):
    ...
    def __init__(self, api, status, state):
        ...
        self._copy_brightness = None
        self._available = True
        self._on = self._type == "wLightBoxS"
    ...
    def is_on(self):
        ...
        return self._type == "wLightBoxS" and self._on
    ...
    async def async_turn_on(self, **kwargs):
        ...
        if(brightness == 0 and self._copy_brightness and self._on == False):
            brightness=self._copy_brightness
    ...
    async def async_turn_off(self, **kwargs):
        """Turn the light off."""
        self._copy_brightness = self._brightness   
        self._on = False
